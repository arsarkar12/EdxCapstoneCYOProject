...
# Read the CSV file
# data <- read_csv("temp_file.csv")

#Subsetting the data to have 10M records only
...
#Uncomment line#124-127 to test RM model only. If it completes successfully, run the full script to get r square & rmse values.
